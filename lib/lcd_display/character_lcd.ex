defmodule LcdDisplay.CharacterLcd do
  @moduledoc """
  High-level API for character-based LCD modules (HD44780 compatible).

  This module starts a display controller process using a given HD44780 driver
  and provides a simple API to execute commands on the display.
  """
