# LcdDisplay.CharacterLcd

`LcdDisplay.CharacterLcd` lets you control a [Hitachi HD44780](https://en.wikipedia.org/wiki/Hitachi_HD44780_LCD_controller)-compatible
